...
from sample_stream import __version__
from sample_stream.example import hello
...
app = typer.Typer(
    name="sample-stream",
    help="Sample lines from a stream.",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]sample-stream[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the sample-stream package.",
    ),
):
